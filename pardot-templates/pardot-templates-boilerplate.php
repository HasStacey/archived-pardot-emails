...
// -------------------------------------------------------------------------------------
  ...
  $template = 'events';         // SCSS theme should be set to $c-orange - TUNE Only
  ...
  $template = 'privacy';        // SCSS theme should be set to $c-orange - TUNE Only
  $template = 'recap';          // SCSS theme should be set to $c-orange - TUNE Only
  $template = 'updates';        // SCSS theme should be set to $c-dkblue - TUNE Only
    ...
    <?php
      switch($template) {
        ...
        case 'newsletter':
          ...
          include('modules/x-image-with-caption.php');
        ...
        case 'notification':
          ...
          include('modules/x-apple-button.php');
          include('modules/x-two-images.php');
        break;
