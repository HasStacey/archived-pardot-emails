                                        ...
                                        <?php
                                          ...
                                          if($template != 'privacy' && $template != 'recap') {
                                            ...
                                            <table pardot-removable>
                                              <tr>
                                                <td>
                                                  <p pardot-region class="featured-image"><img src="https://placeholdit.imgix.net/~text?txtsize=45&txt=Optional+image+480%C3%97225&w=480&h=225" style="display: inline;"></p>
                                                </td>
                                              </tr>
                                            </table>
                                            <?php
